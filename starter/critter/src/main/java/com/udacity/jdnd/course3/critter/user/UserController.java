...
public class UserController {
    ...
    public CustomerDTO saveCustomer(@RequestBody CustomerDTO customerDTO) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Customer does not save", e);
        }
    ...
    public EmployeeDTO saveEmployee(@RequestBody EmployeeDTO employeeDTO) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Employee does not save", e);
        }
